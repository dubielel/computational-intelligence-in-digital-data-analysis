...
def negamax(game, depth, origDepth, scoring, alpha=+inf, beta=-inf, tt=None, alpha_beta=True):
    """
    ...
    for move in possible_moves:
        ...
        move_alpha = -negamax(game, depth - 1, origDepth, scoring, -beta, -alpha, tt, alpha_beta=alpha_beta)
